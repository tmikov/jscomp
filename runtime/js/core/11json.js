...
// Derived with small modification from JSON-js, which is in the public domain
...
// If the JSON object does not yet have a stringify method, give it one.
    ...
    if (typeof JSON.stringify !== 'function') {
        ...
        hidden(JSON, "stringify",  function json_stringify (value, replacer, space) {
